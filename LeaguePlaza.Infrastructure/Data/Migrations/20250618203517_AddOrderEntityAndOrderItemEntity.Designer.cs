...
namespace LeaguePlaza.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250618203517_AddOrderEntityAndOrderItemEntity")]
    partial class AddOrderEntityAndOrderItemEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeaguePlaza.Infrastructure.Data.Entities.QuestEntity", b =>
                {
                    ...
                    b.Property<string>("AdventurerId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LeaguePlaza.Infrastructure.Data.Entities.QuestEntity", b =>
                {
                    ...
                    b.HasOne("LeaguePlaza.Infrastructure.Data.Entities.ApplicationUser", "Creator")
            ...
            modelBuilder.Entity("LeaguePlaza.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
                    b.HasOne("LeaguePlaza.Infrastructure.Data.Entities.CartEntity", "Cart")
                        .WithOne("User")
                        .HasForeignKey("LeaguePlaza.Infrastructure.Data.Entities.ApplicationUser", "CartId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
